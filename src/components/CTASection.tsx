  ...
  return (
    <section className="w-full py-16 px-4 mt-20 mb-20">
      <div className="max-w-7xl mx-auto">
        <div className="relative w-full overflow-hidden rounded-3xl min-h-[500px] flex items-center justify-center" style={{backgroundImage: 'url(/altan-uploads/f205f4a0-427d-4991-8617-497b883351fe.png)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
